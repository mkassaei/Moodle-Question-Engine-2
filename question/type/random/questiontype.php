...
class qtype_random extends question_type {
    ...
    public function save_question_options($question) {
        ...
        $updateobject->name = addslashes($this->question_name($category, !empty($question->questiontext)));
     ...
     */
    public function choose_other_question($questiondata, $excludedquestions) {
