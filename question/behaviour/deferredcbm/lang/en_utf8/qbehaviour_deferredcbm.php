...
$string['assumingcertainty'] = 'You did not select a certainly. Assuming:  {$a}.';
...
$string['markadjustment'] = 'Based on the certainly you expressed, your base mark of {$a->rawmark} was adjusted to {$a->mark}.';
