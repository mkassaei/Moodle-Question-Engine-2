...
require_once(dirname(__FILE__) . '/../adaptive/model.php');

/**
 * Question interaction model for adaptive mode, with no penalties.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qim_adaptivenopenalty extends qim_adaptive {
